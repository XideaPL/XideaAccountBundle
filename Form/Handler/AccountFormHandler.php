...
namespace Xidea\Bundle\AccountBundle\Form\Handler;
 ...
 */
class AccountFormHandler implements FormHandlerInterface
{
    /*
    ...
    public function handle(FormInterface $form, Request $request)
    {
        if ($request->isMethod($this->requestMethod)) {
            ...
            if ($form->isValid()) {
                ...
                $this->eventDispatcher->dispatch(AccountEvents::FORM_VALID, $event);
